...
def dibujar(screen, palabraUsuario, palabraActual, puntos, segundos, palabra_anterior):

    defaultFont= pygame.font.Font( pygame.font.get_default_font(), TAMANNO_LETRA)
    defaultFontGrande= pygame.font.Font( pygame.font.get_default_font(), TAMANNO_LETRA_GRANDE)
    defaultFontSeparadas= pygame.font.Font( pygame.font.get_default_font(), TAMAÑO_LETRA_SEPARADA)   #El tamaño de las letras para las palabras separadas
    ...
    #Para mostrar la palabra anterior separada en silabas
    screen.blit(defaultFontSeparadas.render("Anterior: " + palabra_anterior, 1, COLOR_PALABRA_ANTERIOR), (400, 680))
